    ...
    <div className="footer-container bottom-20 bg-fuchsia-900">
      ...
      <div className="pages" >
        <div className="pages gap-1 grid grid-cols-4">
          ...
          <div className="footer w-auto">
            <h4 className="header p-4 text-lg font-bold">الخدمات</h4>
            <ul className="list-none">
              <Link href={""} className="no-underline">
                <li className="li font-thin"> نبذة عنا</li>
              </Link>
              <Link href={""} className="no-underline">
                <li className="li font-thin"> خدمات التاجر </li>
              </Link>
              <Link href={""} className="no-underline">
                <li className="li font-thin"> خدمات العميل </li>
              </Link>
            </ul>
          </div>
          ...
          <div className="footer w-auto">
            ...
            <ul className="list-none">
              <Link href={"/helpCenter"} className="no-underline">
          ...
          <div className="footer w-auto">
            ...
            <div className="social-icons flex flex-col justify-center mx-auto">
              <p className="email text-white font-thin p-1">Barei5@gmail.org</p>
              <p className="phone text-white font-thin  p-1">0556677889</p>
            </div>
          </div>
      ...
      <div className="reseved flex justify-around p-3">
        <ul className="flex justify-around w-32 ">
          ...
          <Link
            href={
              "https://www.instagram.com/rim_2619?igsh=MTM4eno5ZWJud2N5Zg=="
            }
          ...
          <Link href={""} className="no-underline">
            <li className="text-white  no-underline">
              <svg
                ...
                height="25"
                fill="currentColor"
                className="icon you bi bi-youtube"
                viewBox="0 0 16 16"
              >
          ...
          <Link
            href={"https://x.com/Rim_Cheba09?s=09"}
            className="no-underline"
          >
            <li className="text-white no-underline">
              <svg
                ...
                height="25"
                fill="currentColor"
                className="icon x bi bi-twitter"
                viewBox="0 0 16 16"
              >
