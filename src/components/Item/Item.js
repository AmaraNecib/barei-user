...
export function Item({ id, title, price, image, postFavorite ,postCart,storeImages,storeName,isLiked ,inCart}) {
  ...
  function addCart() {
    ...
    return (
      <div className="flex flex-col items-center justify-center  max-w-sm mx-auto ">
        <div className="relative border border-solid border-gray-200 shadow-md w-[14rem]  h-[21rem] rounded-2xl transition-all ease-in duration-500 ">
