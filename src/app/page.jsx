      ...
      <>
          ...
          <div className="img  mx-auto">
            <div className="contentHero mx-auto align-middle text-center w-1/2 ">
              ...
              <div className="bottons pb-5">
                <button
                    className="mx-2 bg-fuchsia-400 text-white px-4 py-2 rounded-r-full transition duration-200 ease-in-out hover:bg-fuchsia-700 active:bg-fuchsia-900 focus:outline-none">
                  <Link href={"/signup"} className="no-underline">
                    سجل كتاجر
                  </Link>
                </button>
                <button
                    className="mx-2 bg-fuchsia-400 text-white px-4 py-2 rounded-l-full transition duration-200 ease-in-out hover:bg-fuchsia-700 active:bg-fuchsia-900 focus:outline-none">
                  <Link href={"/signup"} className="no-underline">
                    سجل كعميل
                  </Link>
                </button>
        ...
        <div className="SERVICES mt-80  bg-gradient-to-b from-fuchsia-700  to-fuchsia-100 py-5">
          ...
          <div className="service container grid grid-cols-2 gap-4 md:grid-cols-4 my-16 ">
            ...
            <div data-aos="fade-up">
              <div
                  className="cart text-center mx-auto  p-3 h-52 rounded-lg shadow-xl bg-gradient-to-r from-slate-300 via-slate-50 to-slate-300  cursor-pointer  hover:transform hover:-translate-y-6 hover:transition hover:ease-out hover:duration-700">
                <div className="icon mx-auto">
                  <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="black"
                       className="bi bi-graph-up-arrow m-2" viewBox="0 0 16 16">
