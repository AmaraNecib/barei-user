        ...
        <>
            <div className="container shadow-xl rounded-xl  flex my-44 justify-center items-center  ">
                ...
                <div className="flex flex-col justify-center items-center  ">
                    <h1 className="text-3xl font-bold my-2">شكرا لطلبك من بارع </h1>
                    <p className="text-lg font-thin my-2"> رقم الطلبية :<span> {orders?.id}# </span></p>
                    <div className="flex flex-col my-auto">
                    </div>
                    <Link href={"/orders"} className="my-auto">
