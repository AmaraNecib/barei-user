...
import {putProfileInfo} from "@/util/serverActions";
import { useToast } from "@/components/ui/use-toast"
import UploadImageButton from "@/components/profile/UploadImageButton";
                            ...
                            <div className="grid grid-cols-2 gap-2 items-center justify-center">
                                ...
                                <div className="grid justify-center">
                                    ...
                                    <select
                                        ...
                                        className=" border w-80 h-12 outline-none shadow-sm rounded-lg px-3 py-2 mt-1 mb-5 text-sm focus:border-fuchsia-500 focus:ring-2 focus:ring-fuchsia-500  bg-white"
                                    >
                                        <option value='gender' selected disabled></option>
