            ...
            <div className="my-32 shadow-xl rounded-md px-3 ">
                ...
                <div className="container py-5 flex">
                    <div className={'flex flex-col mx-auto w-1/3'}>
                        <div
                            className="container py-3 mb-5 border  shadow-md bg-gradient-to-r from-gray-50 via-white to-gray-50 rounded-xl">
                            ...
                            <p className="mx-2  my-3 text-md font-semibold">تاريخ الطلبية : <span
                                className=" font-light">9873948754</span></p>

                            <p className="mx-2 text-md font-semibold">مكان توصيل الطلبية : <span
                                className=" font-light">الوادي مركز</span></p>
                        </div>


                        <div
                            className="container py-3 mb-5 border  shadow-md  rounded-xl bg-gradient-to-r from-gray-50 via-white to-gray-50">
                        ...
                        <div
                            ...
                            <h3 className={'text-xl font-bold text-yellow-600 mb-5 mx-1 mt-0'}>حالة الطلبية</h3>
                                ...
                                <p className="m-2 text-md font-semibold"> تاريخ التوصيل : <span
                                    className=" font-light"> 3/4/25</span></p>
                    ...
                    <div
                        ...
                        <div className="flex flex-col ">
                            ...
                            <div className="container flex flex-col   mb-3  p-2 gap-3">
                                {order?.items?.map((item) => (
                                    <div
                                        className="container grid grid-cols-2  mb-3 border-1 bg-white  rounded-sm  shadow-sm p-2"
                                        key={item.id}>
                                        <div className="flex">
                                            <Image
                                                width={70}
