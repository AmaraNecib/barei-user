...
export default function Sidebar({ logout, ProfileInfo }) {
        

    console.log(ProfileInfo.user.gender)
    return (
        <>
            <nav
                className="fixed top-0 z-50 w-full opacity-90 border-b border-[#EEEEEE] shadow bg-white dark:bg-gray-800 dark:border-gray-700 mb-5">
                    ...
                    <ul className="space-y-2 font-medium mt-2">
                        ...
                        <li>
                            <Link href="/profile/addresses"
                                  className="flex items-center p-2 text-decoration-none text-gray-900 rounded-lg dark:text-white w-full hover:bg-white dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                     className="bi bi-map" viewBox="0 0 16 16">
                                    <path fill-rule="evenodd"
                                          d="M15.817.113A.5.5 0 0 1 16 .5v14a.5.5 0 0 1-.402.49l-5 1a.5.5 0 0 1-.196 0L5.5 15.01l-4.902.98A.5.5 0 0 1 0 15.5v-14a.5.5 0 0 1 .402-.49l5-1a.5.5 0 0 1 .196 0L10.5.99l4.902-.98a.5.5 0 0 1 .415.103M10 1.91l-4-.8v12.98l4 .8zm1 12.98 4-.8V1.11l-4 .8zm-6-.8V1.11l-4 .8v12.98z"/>
                                </svg>
                                <span className="flex-1 ms-3 whitespace-nowrap">دفتر العناوين</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="/profile/change-password"
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">تغيير كلمة السر</span>
                            </Link>
                        </li>
                        <li>
                            <Link href="#" disabled
                                className="flex items-center p-2 text-decoration-none text-gray-900 rounded-lg
                                dark:text-white w-full  dark:hover:bg-gray-700 group">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                        ...
                        <li>
                            <Link href="/profile/delete-account"
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">حذف الحساب</span>
                            </Link>
                        </li>
                        <li>
                             <AlertDialog className="text-center mt-12" >
                                ...
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogCancel>إلغاء</AlertDialogCancel>
                                        <Link href="/login">
                                            <AlertDialogAction className="bg-red-500" onClick={() => logout()}> تسجيل الخروج </AlertDialogAction>
                                        </Link>
                                    </AlertDialogFooter>
                                </AlertDialogContent>
                            </AlertDialog>
